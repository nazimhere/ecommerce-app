    ...
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-4'>
      ...
      <label htmlFor="image1">
       ...
       <div className='w-full'>
        ...
        <input onChange={(e)=>setDescription(e.target.value)} value={description}   className='w-full max-w-[500px] px-3 py-2' type="text" placeholder='about product' required />
       </div>
       <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
        ...
        <div>
          ...
          <div>
            ...
            <input  onChange={(e)=>setPrice(e.target.value)} value={price}  className='w-full px-3  py-2' type="Number" placeholder='enter price' />
          </div>
       </div>
       <div>
